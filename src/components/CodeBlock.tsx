...
const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  const highlightSyntax = (text: string) => {
    ...
    return text
      .replace(/(const|let|var|function|class|import|export|from|return|if|else|for|while)\b/g, 
      ...
      .replace(/(true|false|null|undefined)\b/g, 
      ...
      <div className="p-0 font-mono text-sm">
        {lines.map((line, index) => (
          ...
          >
            ...
            <div 
              className="flex-1 px-4 py-1 text-gray-100 leading-6 hover:bg-gray-800/50"
