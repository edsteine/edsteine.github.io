const experienceData = [
  ...
  },
  {
    ...
    description: [
      ...
      "Developed predictive analytics module using 5-year historical data to forecast economic trends, achieving strong accuracy in 5-year projections",
      ...
      "Created SEO-optimized public interface significantly increasing organic search visibility and improving Morocco's digital economic presence in academic rankings",
    ...
    projects: [
      ...
      },
      {
        ...
        achievements: [
          ...
          "• Created investor portal with personalized dashboards showing relevant opportunities based on sector preferences and criteria",
